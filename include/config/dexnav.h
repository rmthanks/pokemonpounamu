...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x280 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x281 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x282 // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_0x40F8 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_0x40F9 // Steps for finding hidden Pokémon
