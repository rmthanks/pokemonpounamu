...
enum
{
    ...
    OBJ_EVENT_GFX_YOUNGSTER_TAN,
    OBJ_EVENT_GFX_YOUNGSTER_BROWN,
    OBJ_EVENT_GFX_LASS_TAN,
    OBJ_EVENT_GFX_LASS_BROWN,
    OBJ_EVENT_GFX_SCHOOL_KID_M_TAN,
    OBJ_EVENT_GFX_SCHOOL_KID_M_BROWN,
    OBJ_EVENT_GFX_CAMPER_TAN,
    OBJ_EVENT_GFX_CAMPER_BROWN,
    OBJ_EVENT_GFX_PICNICKER_TAN,
    OBJ_EVENT_GFX_PICNICKER_BROWN,
    OBJ_EVENT_GFX_HIKER_TAN,
    OBJ_EVENT_GFX_HIKER_BROWN,
    OBJ_EVENT_GFX_FISHERMAN_TAN,
    OBJ_EVENT_GFX_FISHERMAN_BROWN,
    OBJ_EVENT_GFX_BUG_CATCHER_TAN,
    OBJ_EVENT_GFX_BUG_CATCHER_BROWN,
    OBJ_EVENT_GFX_MAN_5_TAN,
    OBJ_EVENT_GFX_MAN_5_BROWN,
    OBJ_EVENT_GFX_WOMAN_5_TAN,
    OBJ_EVENT_GFX_WOMAN_5_BROWN,
    OBJ_EVENT_GFX_EXPERT_M_TAN,
    OBJ_EVENT_GFX_EXPERT_M_BROWN,
    OBJ_EVENT_GFX_EXPERT_F_TAN,
    OBJ_EVENT_GFX_EXPERT_F_BROWN,
    OBJ_EVENT_GFX_POKEFAN_M_TAN,
    OBJ_EVENT_GFX_POKEFAN_M_BROWN,
    OBJ_EVENT_GFX_POKEFAN_F_TAN,
    OBJ_EVENT_GFX_POKEFAN_F_BROWN,
    OBJ_EVENT_GFX_MAN_3_TAN,
    OBJ_EVENT_GFX_MAN_3_BROWN,
    OBJ_EVENT_GFX_WOMAN_3_TAN,
    OBJ_EVENT_GFX_WOMAN_3_BROWN,
    OBJ_EVENT_GFX_SAILOR_TAN,
    OBJ_EVENT_GFX_SAILOR_BROWN,
    OBJ_EVENT_GFX_BLACK_BELT_TAN,
    OBJ_EVENT_GFX_BLACK_BELT_BROWN,
    OBJ_EVENT_GFX_BOY_2_TAN,
    OBJ_EVENT_GFX_BOY_2_BROWN,
    OBJ_EVENT_GFX_GENTLEMAN_TAN,
    OBJ_EVENT_GFX_GENTLEMAN_BROWN,
    OBJ_EVENT_GFX_MOM_TAN,
    OBJ_EVENT_GFX_MOM_BROWN,
    OBJ_EVENT_GFX_WOMAN_2_TAN,
    OBJ_EVENT_GFX_WOMAN_2_BROWN,
    OBJ_EVENT_GFX_MANIAC_TAN,
    OBJ_EVENT_GFX_MANIAC_BROWN,
    OBJ_EVENT_GFX_HEX_MANIAC_TAN,
    OBJ_EVENT_GFX_HEX_MANIAC_BROWN,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_NPC_1_TAN 0x11B0
#define OBJ_EVENT_PAL_TAG_NPC_1_BROWN 0x11B1
#define OBJ_EVENT_PAL_TAG_NPC_2_TAN 0x11B2
#define OBJ_EVENT_PAL_TAG_NPC_2_BROWN 0x11B3
#define OBJ_EVENT_PAL_TAG_NPC_3_TAN 0x11B4
#define OBJ_EVENT_PAL_TAG_NPC_3_BROWN 0x11B5
#define OBJ_EVENT_PAL_TAG_NPC_4_TAN 0x11B6
#define OBJ_EVENT_PAL_TAG_NPC_4_BROWN 0x11B7
