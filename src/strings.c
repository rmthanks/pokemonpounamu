...
const u8 gText_DexHoennTitle[] = _("Pounamu Dex");
...
const u8 gText_DexHoennDescription[] = _("POUNAMU region's Pokédex");
...
const u8 gText_DexHoenn[] = _("Pounamu");
...
const u8 gText_Hoenn[] = _("Pounamu");
