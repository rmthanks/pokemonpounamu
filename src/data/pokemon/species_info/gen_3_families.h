...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_DARK, TYPE_FAIRY), // Pounamu NZ retype
        .catchRate = 127,
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_GHOST, TYPE_FLYING), // Pounamu NZ retype
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FAIRY), // Pounamu NZ retype
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
