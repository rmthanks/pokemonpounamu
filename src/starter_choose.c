...
// Pounamu flagship starters — bush / earth / sea (see design docs).
// The full 12-option birthday-gift mechanic replaces this screen in Milestone 2.
#define GRASS_STARTER SPECIES_ROWLET    // bush  — kakapo/ruru reading
#define FIRE_STARTER  SPECIES_CYNDAQUIL // earth — geothermal (regional Typhlosion later)
#define WATER_STARTER SPECIES_PIPLUP    // sea   — korora penguin reading
